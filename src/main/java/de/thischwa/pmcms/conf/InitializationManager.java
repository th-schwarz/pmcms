...
import codes.thischwa.c5c.impl.FilemanagerMessageLibResolver;
import codes.thischwa.c5c.impl.LocalConnector;
import codes.thischwa.c5c.requestcycle.impl.FilemanagerIconLibResolver;
...
public class InitializationManager {
	...
	public static void start(final BasicConfigurator configurator, boolean enableTasksStart) {
		...
		PropertiesLoader.setProperty("connector.messageResolverImpl", FilemanagerMessageLibResolver.class.getName());
