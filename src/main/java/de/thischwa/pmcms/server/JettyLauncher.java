...
import codes.thischwa.c5c.FilemanagerConfigFilter;
...
public class JettyLauncher extends AInitializingTask implements IApplicationLiveCycleListener {
	...
	public void onApplicationStart() {
		...
		try {
			...
			holderConnector.getRegistration().setMultipartConfig(new MultipartConfigElement(Constants.TEMP_DIR.getAbsolutePath()));
			...
			contextDataDir.addFilter(FilemanagerFilter.class, "/filemanager/*", EnumSet.of(DispatcherType.REQUEST, DispatcherType.INCLUDE, DispatcherType.FORWARD));
			contextDataDir.addFilter(FilemanagerConfigFilter.class, "/filemanager/scripts/*", EnumSet.of(DispatcherType.REQUEST));
