 ...
 * 
 * @version $Id: ListenerExportSite.java 2228 2013-01-06 10:50:17Z th-schwarz $
...
public class ListenerExportSite implements SelectionListener {
	...
	public void widgetSelected(SelectionEvent e) {
		...
		try {
			...
			failed = false;
			if (!isInterruptByUser) {
				Collection<File> usedFiles = renderData.getCkResources();
				usedFiles.addAll(renderData.getFilesToCopy());
